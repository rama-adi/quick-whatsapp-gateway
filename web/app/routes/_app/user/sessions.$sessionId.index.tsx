...
//
// Live wiring (unchanged from v1): useSession/useSessionMe stay fresh via the
// cacheBridge (session.status events); useSessionQR is seeded from GET /qr and
// refreshed by the auth.qr event; usePollingInterval is the degraded-stream
// fallback. The QR <img> is fetched as a blob WITH the gateway Bearer (QrImage)
// because the gateway is cross-origin in v2 (§4/§12) — a plain <img src> can't
// carry the Authorization header the same-origin cookie used to stand in for.
