...
export interface components {
    schemas: {
        ...
        WebhookBody: {
            ...
            active?: boolean;
            /**
             * @description Extra HTTP headers attached to every delivery POST. Use for static auth tokens or routing hints the receiver requires. Integrity headers (Content-Type and X-Webhook-*) are gateway-controlled and cannot be overridden.
             * @example {
             *       "X-Tenant": "acme"
             *     }
             */
