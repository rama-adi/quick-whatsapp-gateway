...
[`router.md`](/docs/architecture/router), [`grpc-contracts.md`](/docs/architecture/grpc-contracts),
[`trust-model.md`](/docs/architecture/trust-model).
...
Auth lives in `backend/internal/authz` and is detailed in [`trust-model.md`](/docs/architecture/trust-model):
...
- authz: covered in [`trust-model.md`](/docs/architecture/trust-model).
