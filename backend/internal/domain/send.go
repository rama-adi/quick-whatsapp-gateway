...
type ListSection struct {
	Title string    `json:"title" doc:"Section heading."`
	Rows  []ListRow `json:"rows" doc:"Selectable rows; IDs must be unique across all sections."`
}

type ListRow struct {
	ID          string `json:"id" doc:"Opaque selection identifier returned in the reply event."`
	Title       string `json:"title" doc:"Visible row label."`
	Description string `json:"description,omitempty" doc:"Optional supporting text."`
}
