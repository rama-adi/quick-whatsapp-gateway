...
Tracks implementation status against [`masterplan-mvp.md`](../site-marketing/content/docs/architecture/overview.mdx).
...
Plan: [`plans/plan-router-impl.md`](plan-router-impl.md). Spec: [`specs/router.md`](../site-marketing/content/docs/architecture/router.mdx).
...
Plan: [`plans/plan-grpc-control-plane.md`](plan-grpc-control-plane.md). **Complete —
...
[`archive/mvp-progress-v1.md`](https://github.com/rama-adi/quick-whatsapp-gateway/tree/mvp-v1). The only open v1 item was a manual
...
- **Docs refresh is a tracked requirement:** stale `docs/specs/*` carry superseded banners +
  a [`specs/_V2-STATUS.md`](specification-status.md) index now; full per-spec rewrites land with
