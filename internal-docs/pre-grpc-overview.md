# Split-runtime design history

> **Historical design record — split-runtime transition.** This record captures the original HTTP/assertion topology, initial data model, and migration decisions. Current implementation: [architecture overview](../site-marketing/content/docs/architecture/overview.mdx), [gRPC contracts](../site-marketing/content/docs/architecture/grpc-contracts.mdx), and [data ownership](../site-marketing/content/docs/architecture/store.mdx).
...
- **Trust direction:** the frontend is the *issuer*; the **router** is the *verifier* and the
  ...
  [`specs/router.md`](../site-marketing/content/docs/architecture/router.mdx) and [`plan-router-impl.md`](plan-router-impl.md). The
...
> [`specs/router.md`](../site-marketing/content/docs/architecture/router.mdx), [`specs/trust-model.md`](../site-marketing/content/docs/architecture/trust-model.mdx).
