...
| **Increment 4** — first unary engine slices | 🚧 Active | Migrate session state, account presence, and read receipts through the private engine service and shared application layer. |
