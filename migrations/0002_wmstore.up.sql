...
--   * TEXT keys that participate in PRIMARY/FOREIGN keys become VARCHAR(255)
--     (utf8mb4 needs a bounded length for indexed columns).
...
CREATE TABLE wmstore_nct_salt (
  our_jid VARCHAR(255) PRIMARY KEY,
  salt    BLOB NOT NULL,
